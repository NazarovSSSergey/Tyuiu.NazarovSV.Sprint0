...
using Tyuiu.NazarovSV.Sprint0.Task7.V0.Lib;

namespace Tyuiu.NazarovSV.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Назаров С. В. | СМАРТб-25-1";
            Console.WriteLine("***************************************************                      ");
            Console.WriteLine("* Спринт #0                                                              ");
            Console.WriteLine("* Тема: Создвние итогового решения по спринту                            ");
